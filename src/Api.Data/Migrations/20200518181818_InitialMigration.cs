        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorPorUnidade = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanoCalculoUnidades", x => new { x.PlanoId, x.Id });
                    table.UniqueConstraint("AK_PlanoCalculoUnidades_Uid", x => x.Uid);
                    table.ForeignKey(
                        name: "FK_PlanoCalculoUnidades_Plano_PlanoId",
                        column: x => x.PlanoId,
